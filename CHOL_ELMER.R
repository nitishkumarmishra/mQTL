...
getGeneInfo(mee)
Probe <- get.feature.probe(rm.chr=paste0("chr",c("X","Y", "M")))
...
setwd("C:/Users/nitish.mishra/Desktop/eMap/RTCGAToolbox/TCGABiolink/dataTGCT/CHOL/ELMER/Hypo")
...
setwd("C:/Users/nitish.mishra/Desktop/eMap/RTCGAToolbox/TCGABiolink/dataTGCT/CHOL/ELMER/Hyper")
